# ctrl+shiift+p=> select Interrupte => base
# ctrl = j : cmd에서 테스트 : python fibonacci.py 100
...
# fibonacci 관련 함수들 테스트(cmd창에서 python fibonacci.py 100)
if __name__  ==  "__main__" :
    ...
    fibonacci_print(n)
    print("2. print test :" , fibonacci(n))